...
class VendedorController {
    ...
    def save(Vendedor vendedor) {
        ...
        def participante = participanteService.save(Pessoa, params)
        participante.save failOnError: true
        vendedor.participante = participante
        ...
        request.withFormat {
            form multipartForm {
                def message = message(code: 'default.created.message', args: [message(code: 'vendedor.label', default: 'Vendedor'), vendedor])
    ...
    def update(Vendedor vendedor) {
        ...
        request.withFormat {
            form multipartForm {
                def message = message(code: 'default.updated.message', args: [message(code: 'vendedor.label', default: 'Vendedor'), vendedor])
                alertService.success(text: message)
                redirect vendedor
            }
    ...
    def delete(Vendedor vendedor) {
        ...
        request.withFormat {
            form multipartForm {
                def message = message(code: 'default.deleted.message', args: [message(code: 'vendedor.label', default: 'Vendedor'), vendedor])
                alertService.success(text: message)
